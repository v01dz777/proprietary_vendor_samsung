...
ifneq ($(filter jfltedcm kltedcmactive,$(TARGET_DEVICE)),)
...
include $(CLEAR_VARS)
LOCAL_MODULE := libnfc_sony_jni
LOCAL_MODULE_OWNER := samsung
LOCAL_SRC_FILES := proprietary/lib/libnfc_sony_jni.so
LOCAL_MODULE_PATH := $(TARGET_OUT_SHARED_LIBRARIES)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
...
include $(CLEAR_VARS)
LOCAL_MODULE := libnfc_sony
LOCAL_MODULE_OWNER := samsung
LOCAL_SRC_FILES := proprietary/lib/libnfc_sony.so
LOCAL_MODULE_PATH := $(TARGET_OUT_SHARED_LIBRARIES)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
...
include $(CLEAR_VARS)
LOCAL_MODULE := libnfc_sony_ndef
LOCAL_MODULE_OWNER := samsung
LOCAL_SRC_FILES := proprietary/lib/libnfc_sony_ndef.so
LOCAL_MODULE_PATH := $(TARGET_OUT_SHARED_LIBRARIES)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
